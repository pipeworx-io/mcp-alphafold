...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/alphafold_prediction \
  -H 'Content-Type: application/json' \
  -d '{"qualifier":"P00533"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/alphafold_prediction`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
